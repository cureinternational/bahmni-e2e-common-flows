...
const {
    ...
    accept,
    button,
    link, evaluate, switchTo, closeTab, toLeftOf
} = require('taiko');
...
var drugChartTab = '//a[contains(text(),"Drug Chart") and @ng-click="showDashboard(dashboard)"]'
var generalTab = '//a[contains(text(),"General") and @ng-click="showDashboard(dashboard)"]'
